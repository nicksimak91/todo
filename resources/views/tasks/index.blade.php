...
<div class="row">
    <ul class="list-group list-group-horizontal">
        <li class="list-group-item" style="width: 153px; text-align: center; font-weight: bold">Создана</li>
        <li class="list-group-item" style="width: 153px; text-align: center; font-weight: bold">Постановщик</li>
        <li class="list-group-item" style="width: 153px; text-align: center; font-weight: bold">Описание</li>
        <li class="list-group-item" style="width: 153px; text-align: center; font-weight: bold">Срок</li>
        <li class="list-group-item" style="width: 153px; text-align: center; font-weight: bold">Статус</li>
    </ul>
