            ...
            <div class="border border-2 rounded border-primary p-4 ">
                ...
                <form method="post" action="{{$action}}">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" aria-describedby="creatorHelp" name="creator">
                        <div id="nameHelp" class="form-text">Укажите кто ставит задачу</div>
                    </div>
                    <div class="mb-3">
                        <label for="code" class="form-label">Описание</label>
                        <input type="text" class="form-control" id="code" aria-describedby="descriptionHelp" name="description">
